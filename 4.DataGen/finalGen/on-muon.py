'''
Analysis for muon Yukawa coupling measurement in semileptonic channel.
...
class Analysis():
    '''
    Muon Yukawa coupling analysis in semileptonic WW channel.
    '''
    def __init__(self, cmdline_args):
        ...
        self.output_dir = '/eos/user/h/hfatehi/muon_yukawa/on/stage1'

        # Optional: analysis name
        self.analysis_name = 'Muon Yukawa Analysis'
        ...
        self.output_dir_eos = '/eos/experiment/fcc/ee/analyses/case-studies/higgs/electron_yukawa/FinalRound/on-shell-muon/'
    ...
    def analyzers(self, dframe):
        '''
        Analysis graph for muon Yukawa coupling measurement.
        '''
        ...
        dframe2 = dframe2.Filter("N_IsolatedMuons == 1")
        dframe2 = dframe2.Filter("N_IsolatedElectrons == 0")
        ...
        # ===========================
        # Isolated muon properties
        # ===========================
        dframe2 = dframe2.Define("IsolatedMuon_3Vec", "IsolatedMuon_4Vec[0].Vect()")
        dframe2 = dframe2.Define("IsolatedMuon_P", "IsolatedMuon_4Vec[0].P()")
        dframe2 = dframe2.Define("IsolatedMuon_Phi", "IsolatedMuon_4Vec[0].Phi()")
        dframe2 = dframe2.Define("IsolatedMuon_Theta", "IsolatedMuon_4Vec[0].Theta()")
        dframe2 = dframe2.Define("IsolatedMuon_E", "IsolatedMuon_4Vec[0].E()")
        dframe2 = dframe2.Define("IsolatedMuon_CosTheta", "IsolatedMuon_4Vec[0].CosTheta()")
        dframe2 = dframe2.Define("IsolatedMuon_CosPhi", "TMath::Cos(IsolatedMuon_Phi)")
        dframe2 = dframe2.Define("IsolatedMuon_Charge", "FCCAnalyses::ReconstructedParticle::get_charge(Muons_Isolated)[0]")

        # ===========================
        # Combined masses
        # ===========================
        dframe2 = dframe2.Define("MuonNeutrino_InvariantMass", "(MissingQuantities_4Vec[0] + IsolatedMuon_4Vec[0]).M()")
        ...
        dframe2 = dframe2.Define(
            "RecoParticles_NoPhotonsNoMuons",
            "FCCAnalyses::ReconstructedParticle::remove(RecoParticles_NoPhotons, Muons_PreSelection)",
        )
        dframe2 = dframe2.Define(
            "RecoParticles_NoLeptonsNoPhotons",
            "FCCAnalyses::ReconstructedParticle::remove(RecoParticles_NoPhotonsNoMuons, Electrons_PreSelection)",
        )
        ...
        dframe2 = dframe2.Filter("DiJet_InvariantMass < 50.33")
        ...
        # ===========================
        # Angular separations: Muon vs Jets
        # ===========================
        dframe2 = dframe2.Define("MuonJet1_DeltaR", "IsolatedMuon_4Vec[0].DeltaR(Jets_4Vec[0])")
        dframe2 = dframe2.Define("MuonJet1_DeltaPhi", "IsolatedMuon_4Vec[0].DeltaPhi(Jets_4Vec[0])")
        dframe2 = dframe2.Define("MuonJet1_Angle", "IsolatedMuon_4Vec[0].Angle(Jets_4Vec[0].Vect())")
        dframe2 = dframe2.Define("MuonJet1_CosAngle", "TMath::Cos(MuonJet1_Angle)")

        dframe2 = dframe2.Define("MuonJet2_DeltaR", "IsolatedMuon_4Vec[0].DeltaR(Jets_4Vec[1])")
        dframe2 = dframe2.Define("MuonJet2_DeltaPhi", "IsolatedMuon_4Vec[0].DeltaPhi(Jets_4Vec[1])")
        dframe2 = dframe2.Define("MuonJet2_Angle", "IsolatedMuon_4Vec[0].Angle(Jets_4Vec[1].Vect())")
        dframe2 = dframe2.Define("MuonJet2_CosAngle", "TMath::Cos(MuonJet2_Angle)")

        dframe2 = dframe2.Define("MuonJets_MaxDeltaR", "TMath::Max(MuonJet1_DeltaR, MuonJet2_DeltaR)")
        dframe2 = dframe2.Define("MuonJets_MinDeltaR", "TMath::Min(MuonJet1_DeltaR, MuonJet2_DeltaR)")
        dframe2 = dframe2.Define("MuonJets_MaxDeltaPhi", "TMath::Max(MuonJet1_DeltaPhi, MuonJet2_DeltaPhi)")
        dframe2 = dframe2.Define("MuonJets_MinDeltaPhi", "TMath::Min(MuonJet1_DeltaPhi, MuonJet2_DeltaPhi)")
        dframe2 = dframe2.Define("MuonJets_MaxCosAngle", "TMath::Max(MuonJet1_CosAngle, MuonJet2_CosAngle)")
        dframe2 = dframe2.Define("MuonJets_MinCosAngle", "TMath::Min(MuonJet1_CosAngle, MuonJet2_CosAngle)")

        # ===========================
        # Angular separations: MissingQuantities vs Muon
        # ===========================
        dframe2 = dframe2.Define("MissingQuantitiesMuon_DeltaR", "MissingQuantities_4Vec[0].DeltaR(IsolatedMuon_4Vec[0])")
        dframe2 = dframe2.Define("MissingQuantitiesMuon_DeltaPhi", "MissingQuantities_4Vec[0].DeltaPhi(IsolatedMuon_4Vec[0])")
        dframe2 = dframe2.Define("MissingQuantitiesMuon_Angle", "MissingQuantities_4Vec[0].Angle(IsolatedMuon_4Vec[0].Vect())")
        dframe2 = dframe2.Define("MissingQuantitiesMuon_CosAngle", "TMath::Cos(MissingQuantitiesMuon_Angle)")
        ...
        # ===========================
        dframe2 = dframe2.Define("Event_InvariantMass", "(Jets_4Vec[0] + Jets_4Vec[1] + MissingQuantities_4Vec[0] + IsolatedMuon_4Vec[0]).M()")

        # ===========================
        # Combined system masses
        # ===========================
        dframe2 = dframe2.Define("MuonDiJet_InvariantMass", "(Jets_4Vec[0] + Jets_4Vec[1] + IsolatedMuon_4Vec[0]).M()")
        dframe2 = dframe2.Define("MuonJet1_InvariantMass", "(Jets_4Vec[0] + IsolatedMuon_4Vec[0]).M()")
        dframe2 = dframe2.Define("MuonJet2_InvariantMass", "(Jets_4Vec[1] + IsolatedMuon_4Vec[0]).M()")
        dframe2 = dframe2.Define("DiJet_Energy", "(Jets_4Vec[0] + Jets_4Vec[1]).E()")

        # ===========================
        # System angular properties
        # ===========================
        dframe2 = dframe2.Define("MuonDiJet_Phi", "(Jets_4Vec[0] + Jets_4Vec[1] + IsolatedMuon_4Vec[0]).Phi()")
        dframe2 = dframe2.Define("DiJet_Phi", "(Jets_4Vec[0] + Jets_4Vec[1]).Phi()")

        # ===========================
        # W boson (leptonic) properties
        # ===========================
        dframe2 = dframe2.Define("WBosonLeptonic_InvariantMass", "(IsolatedMuon_4Vec[0] + MissingQuantities_4Vec[0]).M()")
        dframe2 = dframe2.Define("WBosonLeptonic_Theta", "(IsolatedMuon_4Vec[0] + MissingQuantities_4Vec[0]).Theta()")
        ...
        dframe2 = dframe2.Define("Event_EnergyImbalance", "125.0 - MissingQuantities_4Vec[0].E() - IsolatedMuon_4Vec[0].E() - Jets_4Vec[0].E() - Jets_4Vec[1].E()")
        ...
        # ===========================
        dframe2 = dframe2.Define("EventShape_Planarity", "FCCAnalyses::GEOFunctions::EventGeoFunctions::calculatePlanarity(Jet1_3Vec, Jet2_3Vec, IsolatedMuon_3Vec)")
        dframe2 = dframe2.Define("EventShape_Aplanarity", "FCCAnalyses::GEOFunctions::EventGeoFunctions::calculateAplanarity(Jet1_3Vec, Jet2_3Vec, IsolatedMuon_3Vec)")
        dframe2 = dframe2.Define("EventShape_Sphericity", "FCCAnalyses::GEOFunctions::EventGeoFunctions::calculateSphericity(Jet1_3Vec, Jet2_3Vec, IsolatedMuon_3Vec)")
        dframe2 = dframe2.Define("EventShape_Asphericity", "FCCAnalyses::GEOFunctions::EventGeoFunctions::calculateAsphericity(Jet1_3Vec, Jet2_3Vec, IsolatedMuon_3Vec)")
    ...
    def output(self):
        ...
        branch_list = [
            ...
            "MuonJets_MaxDeltaR",
            "MuonJets_MinDeltaR",
            "MuonJets_MaxDeltaPhi",
            "MuonJets_MinDeltaPhi",
            "MuonJets_MaxCosAngle",
            "MuonJets_MinCosAngle",

            # Angular separations: MissingQuantities vs Muon
            "MissingQuantitiesMuon_DeltaR",
            "MissingQuantitiesMuon_DeltaPhi",
            "MissingQuantitiesMuon_Angle",
            "MissingQuantitiesMuon_CosAngle",
            ...
            # Event-level masses
            "Event_InvariantMass",
            "MuonDiJet_InvariantMass",
            "MuonJet1_InvariantMass",
            "MuonJet2_InvariantMass",
            "DiJet_Energy",
